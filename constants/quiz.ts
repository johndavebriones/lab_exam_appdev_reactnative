...
const questions: Question[] = [
  {
    question: 'How does React Native render user interface elements components on mobile services',
    options: ['It compiles entirely into a standard website embedded inside a WebView.',
  ...
  },
  {
    ...
    options: ['Metro Builder', 'Expo Go', 'React Native ClI', 'Cocoapods'],
    answer: 'Expo Go',
  },
  {
  ...
  },
  {
    ...
    options: ['Data managed internally within a component that can change over time.',
  ...
  },
  {
    ...
    options: ['The component triggers a re-render to update the user interface.',
